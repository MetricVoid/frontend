...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"src/Vector2D.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Vector2D, [{
    ...
    key: "subtracting",
    value: function subtracting(another) {
      return new Vector2D(this.x - another.x, this.y - another.y);
    }
  }, {
    key: "adding",
    value: function adding(another) {
      return new Vector2D(this.x + another.x, this.y + another.y);
    }
  }, {
    key: "multiply",
    ...
    key: "multiplying",
    value: function multiplying(scalar) {
      return new Vector2D(this.x * scalar, this.y * scalar);
    }
  }, {
    key: "innerProduct",
    value: function innerProduct(anotherVector) {
    ...
    key: "fromAngle",
    value: function fromAngle(radians) {
...
},{}],"src/Rect2D.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function Rect2D(xOrOrigin, yOrSize, width, height) {
    _classCallCheck(this, Rect2D);

    if (xOrOrigin instanceof Vector2D_1.Vector2D && yOrSize instanceof Vector2D_1.Vector2D) {
      this.origin = xOrOrigin;
      this.size = yOrSize;
    } else if (typeof xOrOrigin === 'number' && typeof yOrSize === 'number' && typeof width === 'number' && typeof height === 'number') {
      this.origin = new Vector2D_1.Vector2D(xOrOrigin, yOrSize);
      this.size = new Vector2D_1.Vector2D(width, height);
    } else {
  ...
  _createClass(Rect2D, [{
    ...
    value: function contains(vector) {
      return this.x < vector.x && this.x + this.width > vector.x && this.y < vector.y && this.y + this.height > vector.y;
    }
  }, {
    key: "translate",
    value: function translate(x, y) {
      if (x instanceof Vector2D_1.Vector2D) {
        this.origin.add(x);
      } else if (y !== undefined) {
        this.origin.add(new Vector2D_1.Vector2D(x, y));
      } else {
        this.origin.add(new Vector2D_1.Vector2D(x, x));
      }
    }
  }, {
    key: "centerRect",
    value: function centerRect(size) {
      return new Rect2D(this.x - size.x / 2, this.y - size.y / 2, size.width, size.height);
    }
  }, {
    key: "x",
    get: function get() {
...
},{"./Vector2D":"src/Vector2D.ts"}],"src/components/Depth.ts":[function(require,module,exports) {
"use strict";
...
(function (Depth) {
  ...
  Depth[Depth["FRONT"] = 2] = "FRONT";
  /** Particle back */

  Depth[Depth["WHITE"] = 3] = "WHITE";
  /** First parallax layer */

  Depth[Depth["BUILDING_1"] = 5] = "BUILDING_1";
  /** Second parallax layer */

  Depth[Depth["BUILDING_2"] = 6] = "BUILDING_2";
  /** Last parallax layer */

  Depth[Depth["SKY"] = 7] = "SKY";
})(Depth = exports.Depth || (exports.Depth = {}));

function getDepthTranslatingFactor(depth) {
  switch (depth) {
    ...
    case Depth.BUILDING_1:
      return 0.7;

    case Depth.BUILDING_2:
      return 0.45;
...
exports.getDepthTranslatingFactor = getDepthTranslatingFactor;
...
/*#__PURE__*/
function () {
  function Component(depth, frame) {
...
},{}],"src/components/Mobile.ts":[function(require,module,exports) {
"use strict";
...
function (_Component_1$Componen) {
  _inherits(Mobile, _Component_1$Componen);

  function Mobile(depth, frame, vel, maxSpeed, acc) {
    var _this;

    _classCallCheck(this, Mobile);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Mobile).call(this, depth, frame));
    _this.vel = vel;
  ...
  _createClass(Mobile, [{
    key: "update",
    value: function update(deltaMs, game) {
      this.vel.add(this.acc.multiplying(deltaMs / 1000));
      var maxSpeedMag = this.maxSpeed * deltaMs / 1000;
...
},{"./Component":"src/components/Component.ts"}],"src/components/Bullet.ts":[function(require,module,exports) {
"use strict";
...
var Bullet =
/*#__PURE__*/
function (_Mobile_1$Mobile) {
  _inherits(Bullet, _Mobile_1$Mobile);
   ...
   * @param frame
   */
  function Bullet(vel, frame) {
    var _this;

    _classCallCheck(this, Bullet);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Bullet).call(this, Depth_1.Depth.FRONT, frame, vel, vel.mag, Vector2D_1.Vector2D.zero));
    _this.vel = vel;
    _this.hasExpired = false;
    return _this;
  }
  ...
  _createClass(Bullet, [{
    key: "update",
    value: function update(deltaMs, game) {
      if (!new Rect2D_1.Rect2D(Vector2D_1.Vector2D.zero, game.scene.dimensions).contains(this.frame.origin)) {
      ...
      _get(_getPrototypeOf(Bullet.prototype), "update", this).call(this, deltaMs, game);
    }
  }, {
    key: "render",
    value: function render(ctx, game) {
...
},{"../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Depth":"src/components/Depth.ts","./Mobile":"src/components/Mobile.ts"}],"images/2Artboard 1.png":[function(require,module,exports) {
module.exports = "/2Artboard 1.01fef11a.png";
},{}],"images/3Artboard 1.png":[function(require,module,exports) {
module.exports = "/3Artboard 1.d0cad064.png";
},{}],"images/4Artboard 1.png":[function(require,module,exports) {
module.exports = "/4Artboard 1.88bf1b2e.png";
},{}],"images/Artboard 1.png":[function(require,module,exports) {
module.exports = "/Artboard 1.45cf7e5a.png";
},{}],"images/building1.png":[function(require,module,exports) {
module.exports = "/building1.ec50827f.png";
},{}],"images/building_01.png":[function(require,module,exports) {
module.exports = "/building_01.a42336ea.png";
},{}],"images/building_02.png":[function(require,module,exports) {
module.exports = "/building_02.8a469993.png";
},{}],"images/building_03.png":[function(require,module,exports) {
module.exports = "/building_03.1f0e0ada.png";
},{}],"images/building_04.png":[function(require,module,exports) {
module.exports = "/building_04.cef2237a.png";
},{}],"images/building_05.png":[function(require,module,exports) {
module.exports = "/building_05.6975c08c.png";
},{}],"images/building_06.png":[function(require,module,exports) {
module.exports = "/building_06.a1488715.png";
},{}],"images/building_07.png":[function(require,module,exports) {
module.exports = "/building_07.83cb6dbc.png";
},{}],"images/building_total.png":[function(require,module,exports) {
module.exports = "/building_total.76efdfe1.png";
},{}],"images/drone_body.png":[function(require,module,exports) {
module.exports = "/drone_body.9c6512d6.png";
},{}],"images/drone_complete.png":[function(require,module,exports) {
module.exports = "/drone_complete.3b1891be.png";
},{}],"images/sky.png":[function(require,module,exports) {
module.exports = "/sky.b4baf7de.png";
},{}],"images/person/walk_0.png":[function(require,module,exports) {
module.exports = "/walk_0.6f697777.png";
},{}],"images/person/walk_1.png":[function(require,module,exports) {
module.exports = "/walk_1.77c47cd2.png";
},{}],"images/person/walk_10.png":[function(require,module,exports) {
module.exports = "/walk_10.b7164e42.png";
},{}],"images/person/walk_11.png":[function(require,module,exports) {
module.exports = "/walk_11.d7cf3cba.png";
},{}],"images/person/walk_2.png":[function(require,module,exports) {
module.exports = "/walk_2.382cc74b.png";
},{}],"images/person/walk_3.png":[function(require,module,exports) {
module.exports = "/walk_3.5d7b3da7.png";
},{}],"images/person/walk_4.png":[function(require,module,exports) {
module.exports = "/walk_4.0f6d8627.png";
},{}],"images/person/walk_5.png":[function(require,module,exports) {
module.exports = "/walk_5.6d34c0a4.png";
},{}],"images/person/walk_6.png":[function(require,module,exports) {
module.exports = "/walk_6.33ec381d.png";
},{}],"images/person/walk_7.png":[function(require,module,exports) {
module.exports = "/walk_7.3d4a371d.png";
},{}],"images/person/walk_8.png":[function(require,module,exports) {
module.exports = "/walk_8.55d42b34.png";
},{}],"images/person/walk_9.png":[function(require,module,exports) {
module.exports = "/walk_9.a0807809.png";
},{}],"images/**/*.png":[function(require,module,exports) {
module.exports = {
  "2Artboard 1": require("./..\\2Artboard 1.png"),
  "3Artboard 1": require("./..\\3Artboard 1.png"),
  "4Artboard 1": require("./..\\4Artboard 1.png"),
  "Artboard 1": require("./..\\Artboard 1.png"),
  "building1": require("./..\\building1.png"),
  "building_01": require("./..\\building_01.png"),
  "building_02": require("./..\\building_02.png"),
  "building_03": require("./..\\building_03.png"),
  "building_04": require("./..\\building_04.png"),
  "building_05": require("./..\\building_05.png"),
  "building_06": require("./..\\building_06.png"),
  "building_07": require("./..\\building_07.png"),
  "building_total": require("./..\\building_total.png"),
  "drone_body": require("./..\\drone_body.png"),
  "drone_complete": require("./..\\drone_complete.png"),
  "sky": require("./..\\sky.png"),
  "person": {
    "walk_0": require("./..\\person\\walk_0.png"),
    "walk_1": require("./..\\person\\walk_1.png"),
    "walk_10": require("./..\\person\\walk_10.png"),
    "walk_11": require("./..\\person\\walk_11.png"),
    "walk_2": require("./..\\person\\walk_2.png"),
    "walk_3": require("./..\\person\\walk_3.png"),
    "walk_4": require("./..\\person\\walk_4.png"),
    "walk_5": require("./..\\person\\walk_5.png"),
    "walk_6": require("./..\\person\\walk_6.png"),
    "walk_7": require("./..\\person\\walk_7.png"),
    "walk_8": require("./..\\person\\walk_8.png"),
    "walk_9": require("./..\\person\\walk_9.png")
  }
};
},{"./..\\2Artboard 1.png":"images/2Artboard 1.png","./..\\3Artboard 1.png":"images/3Artboard 1.png","./..\\4Artboard 1.png":"images/4Artboard 1.png","./..\\Artboard 1.png":"images/Artboard 1.png","./..\\building1.png":"images/building1.png","./..\\building_01.png":"images/building_01.png","./..\\building_02.png":"images/building_02.png","./..\\building_03.png":"images/building_03.png","./..\\building_04.png":"images/building_04.png","./..\\building_05.png":"images/building_05.png","./..\\building_06.png":"images/building_06.png","./..\\building_07.png":"images/building_07.png","./..\\building_total.png":"images/building_total.png","./..\\drone_body.png":"images/drone_body.png","./..\\drone_complete.png":"images/drone_complete.png","./..\\sky.png":"images/sky.png","./..\\person\\walk_0.png":"images/person/walk_0.png","./..\\person\\walk_1.png":"images/person/walk_1.png","./..\\person\\walk_10.png":"images/person/walk_10.png","./..\\person\\walk_11.png":"images/person/walk_11.png","./..\\person\\walk_2.png":"images/person/walk_2.png","./..\\person\\walk_3.png":"images/person/walk_3.png","./..\\person\\walk_4.png":"images/person/walk_4.png","./..\\person\\walk_5.png":"images/person/walk_5.png","./..\\person\\walk_6.png":"images/person/walk_6.png","./..\\person\\walk_7.png":"images/person/walk_7.png","./..\\person\\walk_8.png":"images/person/walk_8.png","./..\\person\\walk_9.png":"images/person/walk_9.png"}],"src/Image.ts":[function(require,module,exports) {
"use strict";
...
var imageUrlFlattenedMapping = new Map();

function flattenAndAdd(nestedMapping) {
  var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';

  for (var _i = 0, _Object$keys = Object.keys(nestedMapping); _i < _Object$keys.length; _i++) {
    var pathPart = _Object$keys[_i];
    var urlOrNestedMapping = nestedMapping[pathPart];
...
try {
  for (var _iterator = imageUrlFlattenedMapping.keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var imageName = _step.value;
...
function loadImages() {
  return new Promise(function (resolve) {
    ...
    var updateLoadStatus = function updateLoadStatus() {
      loadStatus.innerText = "Loading image: [".concat(loaded, " / ").concat(images.size, "]");
    };
    ...
    try {
      var _loop = function _loop() {
        ...
        image.load().then(function () {
          ...
          loadStatus.innerText = "Failed to load \"".concat(name, "\": ").concat(error);
        });
      };

      for (var _iterator2 = images.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        _loop();
      }
    } catch (err) {
...
function getImage(name) {
  ...
  if (image === undefined) {
    throw new Error("Cannot find image \"".concat(name, "\". Available: ").concat(Array.from(imageUrlFlattenedMapping.keys()).join(', '), "."));
  }
...
},{"./../images/**/*.png":"images/**/*.png"}],"src/components/Fragment.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Mobile_1$Mobile) {
  _inherits(Fragment, _Mobile_1$Mobile);
   ...
   */
  function Fragment(depth, frame, vel, acc, updator, destroyCondition) {
    var _this;

    var lifeSpan = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 1000;
    var color = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : 'red';
    var rotConstant = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : 0.01;

    _classCallCheck(this, Fragment);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Fragment).call(this, depth, frame, vel, 200, acc));
    _this.updator = updator;
    _this.destroyCondition = destroyCondition;
    _this.lifeSpan = lifeSpan;
    _this.color = color;
    _this.rotConstant = rotConstant;
    _this.theta = Math.random();
    _this.birthdate = Date.now();
    return _this;
  }
  ...
  _createClass(Fragment, [{
    key: "update",
    value: function update(deltaMs, game) {
      if (this.livedDuration > this.lifeSpan || this.destroyCondition !== undefined && this.destroyCondition(this)) {
        game.removeComponent(this);
      }

      _get(_getPrototypeOf(Fragment.prototype), "update", this).call(this, deltaMs, game);
    ...
    key: "createExplosion",
    value: function createExplosion(game, pos, num, size) {
      for (var i = 0; i < num; i++) {
        var rSize = this.randNorm() * size;
        var frame = new Rect2D_1.Rect2D(pos.copy(), new Vector2D_1.Vector2D(rSize, rSize));
        var dir = Vector2D_1.Vector2D.random.multiplying(200);
        var fragment = new Fragment(Depth_1.Depth.FRONT, frame, dir, dir.multiplying(-0.1), function (vel, acc) {
          acc.limit(vel.mag);
        }, function (frag) {
...
},{"../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Depth":"src/components/Depth.ts","./Mobile":"src/components/Mobile.ts"}],"src/components/Person.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Mobile_1$Mobile) {
  _inherits(Person, _Mobile_1$Mobile);

  function Person(depth, start, speed, left, right) {
    var _this;

    _classCallCheck(this, Person);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Person).call(this, depth, new Rect2D_1.Rect2D(start, new Vector2D_1.Vector2D(200, 200)), Vector2D_1.Vector2D.zero, 200, Vector2D_1.Vector2D.zero));
    _this.start = start;
    _this.speed = speed;
    _this.left = left;
    _this.right = right; // Start at different frame to prevent mob effect.

    _this.currIdx = Math.floor(Math.random() * Person.numFrames);
    _this.isAlive = true;
    _this.vel = Person.randomDir.multiplying(speed);
    return _this;
  }
  ...
  _createClass(Person, [{
    ...
    value: function update(deltaMs, game) {
      if (!this.isAlive) {
        Fragment_1.Fragment.createExplosion(game, this.frame.center, 20, this.frame.width / 15);
        game.scene.removeComponent(this);
      }

      if (this.frame.x < this.left - 70) {
        this.vel = Vector2D_1.Vector2D.unitVectors.right.multiplying(this.speed);
      }

      if (this.frame.x + 130 > this.right) {
        this.vel = Vector2D_1.Vector2D.unitVectors.left.multiplying(this.speed);
      }

      _get(_getPrototypeOf(Person.prototype), "update", this).call(this, deltaMs, game);
    }
  }, {
    key: "render",
    value: function render(ctx, game) {
      var image = Image_1.getImage(Person.dir + Math.floor(this.currIdx) % Person.numFrames);
      ctx.save();
    ...
    key: "chance",
    value: function chance(prob) {
      return Math.random() < prob;
    }
  }, {
    key: "randomDir",
    get: function get() {
      return Math.floor(Math.random() * 2) === 0 ? Vector2D_1.Vector2D.unitVectors.left : Vector2D_1.Vector2D.unitVectors.right;
    }
  }]);
...
Person.dir = 'person/walk_';
Person.numFrames = 12;
},{"../Image":"src/Image.ts","../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Fragment":"src/components/Fragment.ts","./Mobile":"src/components/Mobile.ts"}],"src/Keyboard.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Keyboard() {
    ...
    window.addEventListener('keydown', function (event) {
      _this.keyStates[event.keyCode] = true;
    });
    window.addEventListener('keyup', function (event) {
      _this.keyStates[event.keyCode] = false;
    });
  }
  /** 判断一个按键是否被按下了 */
  ...
  _createClass(Keyboard, [{
    ...
    key: "isKeysPressed",
    value: function isKeysPressed(keys) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;
...
},{}],"src/MonoDimensionTransitionControl.ts":[function(require,module,exports) {
"use strict";
...
function solveQuad(a, b, c) {
  ...
  return (-b + sign(a) * Math.pow(D, 0.5)) / (2 * a);
}

var MonoDimensionTransitionControl =
/*#__PURE__*/
function () {
  function MonoDimensionTransitionControl(
  /** Initial value */
  lastValue, accelerationPerSecSq) {
    _classCallCheck(this, MonoDimensionTransitionControl);
    ...
    this.finalTime = 0;
    /** Target value of the current transisiotn */
  ...
  _createClass(MonoDimensionTransitionControl, [{
    key: "setTarget",
    value: function setTarget(targetValue) {
      this.lastValue = this.getValue();
      var x = targetValue - this.lastValue;
      ...
      var now = Date.now();
      var v = this.getVelocity(now); // Find a solution for reverse time

      var t = solveQuad(this.acceleration, 2 * v, 0.5 * Math.pow(v, 2) / this.acceleration - x);
      ...
      if (Number.isNaN(t) || t < 0) {
        ...
        t = solveQuad(this.acceleration, 2 * v, 0.5 * Math.pow(v, 2) / this.acceleration - x);
      }

      var a = this.acceleration;
      this.initialTime = now;
      this.reverseTime = this.initialTime + t;
      this.reverseValue = this.lastValue + 0.5 * a * Math.pow(t, 2) + v * t;
    ...
    value: function getVelocity() {
      ...
      return now < this.reverseTime ? this.lastStartingVelocity + (now - this.initialTime) * this.acceleration : now < this.finalTime ? this.lastStartingVelocity + (2 * this.reverseTime - this.initialTime - now) * this.acceleration : 0;
    }
  }, {
    key: "getValue",
    value: function getValue() {
      ...
      if (now < this.reverseTime) {
        var t = now - this.initialTime;
        return this.lastValue + 0.5 * this.acceleration * Math.pow(t, 2) + this.lastStartingVelocity * t;
      } else if (now < this.finalTime) {
        var _t = now - this.reverseTime;

        return this.reverseValue - 0.5 * this.acceleration * Math.pow(_t, 2) + this.reverseVelocity * _t;
      } else {
  ...
  return MonoDimensionTransitionControl;
}();
...
var Depth_1 = require("./components/Depth");

var Person_1 = require("./components/Person");

var Keyboard_1 = require("./Keyboard");

var MonoDimensionTransitionControl_1 = require("./MonoDimensionTransitionControl");
...
function () {
  function Game(dimensions) {
    ...
    this.canvases = [];
    this.cameraCenter = Vector2D_1.Vector2D.zero;
    this.cameraScale = 1;
    this.cameraCenterXTransition = new MonoDimensionTransitionControl_1.MonoDimensionTransitionControl(0, 10000);
    this.cameraCenterYTransition = new MonoDimensionTransitionControl_1.MonoDimensionTransitionControl(0, 10000);
    ...
    this.onMouseUpEvent = function (event) {
      ...
      var position = new Vector2D_1.Vector2D(event.clientX, event.clientY).multiplying(1 / _this.cameraScale).adding(bounds.origin);
      console.log(bounds, position);

      var component = _this.componentAtPosition(position);
    ...
    this.onTouchEndEvent = function (event) {
      ...
      var position = new Vector2D_1.Vector2D(event.touches.item(0).clientX, event.touches.item(0).clientY).multiplying(1 / _this.cameraScale).adding(bounds.origin);
      console.log(bounds, position);
    ...
    Object.keys(Depth_1.Depth).map(Number).filter(function (key) {
      ...
      _this.canvases[key] = [canvas, canvas.getContext('2d')];
  ...
  _createClass(Game, [{
    key: "setCamera",
    value: function setCamera(newCenter, scale) {
      this.cameraCenterXTransition = new MonoDimensionTransitionControl_1.MonoDimensionTransitionControl(newCenter.x, 10000);
      this.cameraCenterYTransition = new MonoDimensionTransitionControl_1.MonoDimensionTransitionControl(newCenter.y, 10000);
      this.cameraScale = scale;
    }
  }, {
    key: "moveCamera",
    value: function moveCamera(newCenter, scale) {
    ...
    value: function render() {
      this.canvases.forEach(function (canvas) {
        return canvas[1].clearRect(0, 0, canvas[0].width, canvas[0].height);
      ...
      if (this.scene != null) {
        ...
        try {
          for (var _iterator = this.scene.components.values()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = this.components.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          this.renderComponent(_component, this.canvases[_component.depth][1]);
        }
      } catch (err) {
        _didIteratorError2 = true;
        _iteratorError2 = err;
    ...
    value: function checkCollisions() {
      ...
      try {
        for (var _iterator3 = this.scene.components[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          if (person instanceof Person_1.Person) {
            ...
            try {
              for (var _iterator4 = this.scene.components[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var bullet = _step4.value;

                if (bullet instanceof Bullet_1.Bullet) {
                  var x = bullet.frame.x;
                  var y = bullet.frame.y;
                  var myX = person.frame.x;
                  var myY = person.frame.y;
                  var w = person.frame.width;
                  var h = person.frame.height;

                  if (x <= myX + w && x >= myX && y <= myY + h && y >= myY) {
                    (function () {
                      person.die();
                      var newPerson = new Person_1.Person(person.depth, person.start, person.speed, person.left, person.right);
                      setTimeout(function () {
                        _this2.scene.addComponent(newPerson);
                      }, Math.random() * 5000);
    ...
    value: function update() {
      ...
      this.cameraCenter.y = Math.min(this.cameraCenterYTransition.getValue(), this.scene.dimensions.height - window.innerHeight / 2 / this.cameraScale); // if ((x + width) > game.scene!.dimensions.x) {
      ...
      try {
        for (var _iterator5 = this.components.values()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var _component2 = _step5.value;

          _component2.update(deltaMs, this);
        }
      } catch (err) {
      ...
      if (this.scene != null) {
        ...
        try {
          for (var _iterator6 = this.scene.components.values()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
    ...
    value: function setCanvasDimension(newDimensions) {
      this.canvases.forEach(function (canvas) {
    ...
    key: "renderComponent",
    value: function renderComponent(component, context) {
      ...
      var translatingFactor = Depth_1.getDepthTranslatingFactor(component.depth);
      var cameraScale = this.cameraScale; // const cameraScale = this.cameraScale;

      context.translate(window.innerWidth / 2 + cameraScale * (component.frame.x - this.cameraCenter.x * translatingFactor), window.innerHeight / 2 + cameraScale * (component.frame.y - this.cameraCenter.y * translatingFactor));
      context.scale(cameraScale, cameraScale); // context.translate(
    ...
    value: function getBounds() {
      var size = new Vector2D_1.Vector2D(window.innerWidth, window.innerHeight);
      return new Rect2D_1.Rect2D(this.cameraCenter.adding(size.multiplying(-0.5)), size.multiplying(1 / this.cameraScale));
    }
  }, {
    key: "transitionToScene",
    value: function transitionToScene(scene) {
      if (this.scene != null) {
        this.scene.sceneWillDisappear();
      }

      this.scene = scene;
      scene.sceneDidLoad(); // The following is supposed to be called after the animation ended
      // Animations hasn't been implemented yet

      scene.sceneWillAppear();
    }
  }, {
    key: "componentAtPosition",
    value: function componentAtPosition(position) {
      var hitComponents = new Array();
      var _iteratorNormalCompletion7 = true;
      var _didIteratorError7 = false;
      var _iteratorError7 = undefined;

      try {
        for (var _iterator7 = this.components.values()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var _component3 = _step7.value;

          if (_component3.frame.contains(position)) {
            hitComponents.push(_component3);
          }
        }
      } catch (err) {
      ...
      if (this.scene != null) {
        ...
        try {
          for (var _iterator8 = this.scene.components.values()[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      ...
      return hitComponents.length > 0 ? hitComponents.reduce(function (a, b) {
...
exports.Game = Game;
},{"./components/Bullet":"src/components/Bullet.ts","./components/Depth":"src/components/Depth.ts","./components/Person":"src/components/Person.ts","./Keyboard":"src/Keyboard.ts","./MonoDimensionTransitionControl":"src/MonoDimensionTransitionControl.ts","./Rect2D":"src/Rect2D.ts","./Vector2D":"src/Vector2D.ts"}],"src/components/Text.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component_1$Componen) {
  _inherits(Text, _Component_1$Componen);

  function Text(depth, origin, content) {
    var _this;

    _classCallCheck(this, Text);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Text).call(this, depth, new Rect2D_1.Rect2D(origin, new Vector2D_1.Vector2D(0, 0))));
    ...
    _this.anchor = new Vector2D_1.Vector2D(0.5, 0.5);
    return _this;
  }
  ...
  _createClass(Text, [{
    ...
    key: "render",
    value: function render(ctx, game) {
      ctx.font = "".concat(this.fontSize, "px ").concat(this.fontFamily);
      ctx.textAlign = 'center';
      ctx.fillStyle = this.style;
      var canvasTextSize = ctx.measureText(this.content);
      var textSize = new Vector2D_1.Vector2D(canvasTextSize.width, this.fontSize + 10);
      var translatedTextPosition = this.anchor.innerProduct(textSize);
      this.frame.origin.add(textSize.adding(this.frame.size.multiplying(-1)).multiplying(-0.5));
      this.frame.size = textSize; // ctx.fillRect(0, 0, textSize.width, textSize.height)

      ctx.fillText(this.content, translatedTextPosition.x, translatedTextPosition.y);
    }
  }]);
...
exports.Text = Text;
},{"./Component":"src/components/Component.ts","../Vector2D":"src/Vector2D.ts","../Rect2D":"src/Rect2D.ts"}],"src/components/FXText.ts":[function(require,module,exports) {
"use strict";
...
var FXText =
/*#__PURE__*/
function (_Text_1$Text) {
  _inherits(FXText, _Text_1$Text);

  function FXText() {
    _classCallCheck(this, FXText);

    return _possibleConstructorReturn(this, _getPrototypeOf(FXText).apply(this, arguments));
  }

  _createClass(FXText, [{
    key: "update",
    value: function update(deltaMs, game) {
      var randXY = new Vector2D_1.Vector2D((Math.random() - 0.5) * 2, (Math.random() - 0.5) * 2).innerProduct(this.frame.size);
      Fragment_1.Fragment.createExplosion(game, this.frame.center.adding(randXY), 5, 4);
    }
  }]);
...
exports.FXText = FXText;
},{"../Vector2D":"src/Vector2D.ts","./Fragment":"src/components/Fragment.ts","./Text":"src/components/Text.ts"}],"src/components/TextButton.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Text_1$Text) {
  _inherits(TextButton, _Text_1$Text);

  function TextButton(depth, origin, content, callback) {
    var _this;

    _classCallCheck(this, TextButton);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TextButton).call(this, depth, origin, content));
...
},{"./Text":"src/components/Text.ts"}],"src/components/White.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component_1$Componen) {
  _inherits(White, _Component_1$Componen);
  ...
  function White() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(White).apply(this, arguments));
    _this.alpha = 0.5;
...
exports.White = White;
},{"./Component":"src/components/Component.ts"}],"src/scenes/Scene.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function () {
  function Scene(game, dimensions) {
  ...
  _createClass(Scene, [{
    ...
    key: "sceneWillDisappear",
    value: function sceneWillDisappear() {}
    /** Invoked when the scene is added to the Game and will be presented to the user */

  }, {
    key: "sceneWillAppear",
    value: function sceneWillAppear() {}
  }, {
    key: "addComponent",
    value: function addComponent(component) {
      this.components.add(component);
...
exports.Scene = Scene;
},{}],"src/components/Background.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component_1$Componen) {
  _inherits(Background, _Component_1$Componen);

  function Background(depth, image) {
    var _this;

    _classCallCheck(this, Background);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Background).call(this, depth, new Rect2D_1.Rect2D(Vector2D_1.Vector2D.zero, new Vector2D_1.Vector2D(image.width, image.height))));
    _this.image = image;
    return _this;
  }
...
},{"../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Component":"src/components/Component.ts"}],"src/components/Drone.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Mobile_1$Mobile) {
  _inherits(Drone, _Mobile_1$Mobile);
  ...
  function Drone(frame) {
    ...
    var maxSpeed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;
    var vel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : Vector2D_1.Vector2D.zero;
    var accMag = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 50;

    _classCallCheck(this, Drone);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Drone).call(this, Depth_1.Depth.FRONT, frame, vel, maxSpeed, Vector2D_1.Vector2D.zero));
    _this.maxSpeed = maxSpeed;
    _this.vel = vel;
    _this.accMag = accMag;
    _this.reloadDurationMs = 100;
  ...
  _createClass(Drone, [{
    ...
    value: function update(deltaMs, game) {
      ...
      if (this.isAccelerating(game)) {
        ...
        // Brake
        this.acc = this.vel.normalized().multiplying(-1 * this.accMag);
      }

      _get(_getPrototypeOf(Drone.prototype), "update", this).call(this, deltaMs, game);

      this.updateCamera(game);

      if (game.keyboard.isKeyPressed(Keyboard_1.Key.SPACE)) {
    ...
    key: "updateCamera",
    value: function updateCamera(game) {
      var height = Math.max((game.scene.dimensions.y - this.frame.center.y) * 1.4, 600);
      var scale = height / window.innerHeight;
      game.moveCamera(new Vector2D_1.Vector2D(this.frame.x, game.scene.dimensions.y - height / 2), 1 / scale);
    }
  }, {
    key: "render",
    value: function render(ctx) {
      var img = Image_1.getImage('drone_body');
      ctx.save();

      if (Math.abs(this.vel.x) > 5) {
        var angle = this.vel.x / 30 * Math.PI / 8;
        ctx.rotate(angle);
      }
    ...
    value: function fire(game) {
      var frame = new Rect2D_1.Rect2D(this.frame.center.copy(), new Vector2D_1.Vector2D(20, 3));
      var dir = this.vel.normalized();

      if (this.vel.mag < 5) {
        dir = Vector2D_1.Vector2D.unitVectors.right;
      }

      dir.multiply(2000);
      var bullet = new Bullet_1.Bullet(this.vel.adding(dir), frame);
    ...
    key: "isAccelerating",
    value: function isAccelerating(game) {
      return game.keyboard.isKeysPressed([Keyboard_1.Key.W, Keyboard_1.Key.A, Keyboard_1.Key.S, Keyboard_1.Key.D]);
    }
  }, {
    key: "heading",
     ...
     */
    value: function heading(game) {
      var h = new Vector2D_1.Vector2D(0, 0);
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = Drone.accVecs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var o = _step.value;
    ...
    get: function get() {
      return [{
        key: Keyboard_1.Key.W,
        dir: Vector2D_1.Vector2D.unitVectors.up
      }, {
        key: Keyboard_1.Key.S,
        dir: Vector2D_1.Vector2D.unitVectors.down
      }, {
        key: Keyboard_1.Key.A,
        dir: Vector2D_1.Vector2D.unitVectors.left
      }, {
        key: Keyboard_1.Key.D,
        dir: Vector2D_1.Vector2D.unitVectors.right
      }];
    }
  }]);
...
exports.Drone = Drone;
},{"../Image":"src/Image.ts","../Keyboard":"src/Keyboard.ts","../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Bullet":"src/components/Bullet.ts","./Depth":"src/components/Depth.ts","./Mobile":"src/components/Mobile.ts"}],"src/components/Obstacle.ts":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Component_1$Componen) {
  _inherits(Obstacle, _Component_1$Componen);

  function Obstacle(imageName, x, y, bottomAlign) {
    var _this;

    _classCallCheck(this, Obstacle);

    var image = Image_1.getImage(imageName);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Obstacle).call(this, Depth_1.Depth.FRONT, new Rect2D_1.Rect2D(x, bottomAlign ? y - image.height : y, image.width, image.height)));
    _this.image = image;
    return _this;
  }
...
},{"../Image":"src/Image.ts","../Rect2D":"src/Rect2D.ts","./Component":"src/components/Component.ts","./Depth":"src/components/Depth.ts"}],"src/scenes/Scene1.ts":[function(require,module,exports) {
"use strict";
...
var Obstacle_1 = require("../components/Obstacle");

var Person_1 = require("../components/Person");

var White_1 = require("../components/White");
...
var Scene1 =
/*#__PURE__*/
function (_Scene_1$Scene) {
  _inherits(Scene1, _Scene_1$Scene);

  function Scene1(game) {
    _classCallCheck(this, Scene1);

    return _possibleConstructorReturn(this, _getPrototypeOf(Scene1).call(this, game, new Vector2D_1.Vector2D(7000, 2000)));
  }

  _createClass(Scene1, [{
    key: "sceneWillDisappear",
    value: function sceneWillDisappear() {// throw new Error("Method not implemented.");
    }
  }, {
    key: "sceneWillAppear",
    value: function sceneWillAppear() {// throw new Error("Method not implemented.");
    }
  }, {
    key: "createPerson",
    value: function createPerson(base, configIdx) {
      var config = Scene1.personConfigs[configIdx];
      console.log(config);
      var left = config.left;
      var right = config.right;
      var height = config.height;
      this.addComponent(new Person_1.Person(Depth_1.Depth.FRONT, new Vector2D_1.Vector2D(rand(base + left, base + right), 1930 - height), rand(3.5, 7), base + left, base + right));
    }
  }, {
    key: "sceneDidLoad",
    value: function sceneDidLoad() {
      for (var i = 20; i < 7000; i += Math.random() * 100 + 550) {
        ...
        this.addComponent(new Obstacle_1.Obstacle("building_0".concat(id), i, 2100, true));
      }

      this.addComponent(new Background_1.Background(Depth_1.Depth.SKY, Image_1.getImage('sky')));
      this.addComponent(new Background_1.Background(Depth_1.Depth.BUILDING_1, Image_1.getImage('building_total')));
      this.addComponent(new Background_1.Background(Depth_1.Depth.BUILDING_2, Image_1.getImage('2Artboard 1')));
      this.addComponent(new White_1.White(Depth_1.Depth.WHITE, new Rect2D_1.Rect2D(Vector2D_1.Vector2D.zero, Vector2D_1.Vector2D.zero)));
      this.addComponent(new Drone_1.Drone(new Rect2D_1.Rect2D(new Vector2D_1.Vector2D(50, 1200), new Vector2D_1.Vector2D(60, 60))));
    }
  }]);
...
},{"../components/Background":"src/components/Background.ts","../components/Depth":"src/components/Depth.ts","../components/Drone":"src/components/Drone.ts","../components/Obstacle":"src/components/Obstacle.ts","../components/Person":"src/components/Person.ts","../components/White":"src/components/White.ts","../Image":"src/Image.ts","../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Scene":"src/scenes/Scene.ts"}],"src/scenes/IntroScene.ts":[function(require,module,exports) {
"use strict";
...
var FXText_1 = require("../components/FXText");

var TextButton_1 = require("../components/TextButton");
...
/*#__PURE__*/
function (_Scene_1$Scene) {
  _inherits(IntroScene, _Scene_1$Scene);
  ...
  function IntroScene(game) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(IntroScene).call(this, game, new Vector2D_1.Vector2D(8000, 5000)));

    _this.onButtonTapped = function (source) {
      _this.game.transitionToScene(new Scene1_1.Scene1(_this.game));
    };
  ...
  _createClass(IntroScene, [{
    key: "sceneDidLoad",
    value: function sceneDidLoad() {
      _get(_getPrototypeOf(IntroScene.prototype), "sceneDidLoad", this).call(this); // this.addComponent(
      ...
      var gameTitle = new FXText_1.FXText(Depth_1.Depth.FRONT, this.dimensions.innerProduct(new Vector2D_1.Vector2D(0.5, 0.48)), 'Done Crisis');
      gameTitle.fontSize = 60;
      gameTitle.style = '#a0a0a0';
      var startGameButton = new TextButton_1.TextButton(Depth_1.Depth.FRONT, this.dimensions.innerProduct(new Vector2D_1.Vector2D(0.5, 0.51)), 'START', this.onButtonTapped);
      startGameButton.fontSize = 30;
      startGameButton.style = '#f0f0f0';
      var backgroundLayer = new White_1.White(Depth_1.Depth.WHITE, new Rect2D_1.Rect2D(Vector2D_1.Vector2D.zero, this.dimensions));
    ...
    key: "sceneWillAppear",
    value: function sceneWillAppear() {
      _get(_getPrototypeOf(IntroScene.prototype), "sceneWillAppear", this).call(this);
...
},{"../components/Depth":"src/components/Depth.ts","../components/FXText":"src/components/FXText.ts","../components/TextButton":"src/components/TextButton.ts","../components/White":"src/components/White.ts","../Rect2D":"src/Rect2D.ts","../Vector2D":"src/Vector2D.ts","./Scene":"src/scenes/Scene.ts","./Scene1":"src/scenes/Scene1.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Image_1.loadImages();

          case 2:
            game = new Game_1.Game(new Vector2D_1.Vector2D(window.innerWidth, window.innerHeight));
            window.addEventListener('resize', function () {
              game.setCanvasDimension(new Vector2D_1.Vector2D(window.innerWidth, window.innerHeight));
            ...
            game.transitionToScene(new IntroScene_1.IntroScene(game)); // game.addComponent(new TestSquare(Depth.SKY, game.frame));
...
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js","./Game":"src/Game.ts","./Image":"src/Image.ts","./scenes/IntroScene":"src/scenes/IntroScene.ts","./Vector2D":"src/Vector2D.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
